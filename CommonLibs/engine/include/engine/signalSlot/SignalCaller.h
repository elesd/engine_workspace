		...
		*/
		...
		public:
			...
			*/
			...
			{
				return bindCallable(t, callback, engine::utils::GenSequence<sizeof...(Ts)>{});
			}
		private:
			...
			*/
			...
			static std::function<void(Ts...)> bindCallable(T *t, void (T::*callback)(Ts...), engine::utils::Index<Is...>)
			{
				return std::bind(callback, t, engine::utils::CustomPlaceholder<Is> {}...);
			}
		...
		public:
			...
			*/
			...
			{
				call(args, engine::utils::GenSequence<sizeof...(Ts)>{});
			}
		...
		private:
			...
			*/
			...
			void call(const std::tuple<Args...>& tup, engine::utils::Index<Is...> indeces)
			{
				f(std::get<Is>(tup)...);
			}
