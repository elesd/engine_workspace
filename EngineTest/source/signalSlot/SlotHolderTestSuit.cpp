...
#include "signalSlot/SlotHolderTestSuit.h"
...
namespace
{
	class TestSignalManager : public engine::ISignalManager
	{
	public:
		void addTask(std::unique_ptr<engine::ISignalTask> task) override
		{
			(*task)();
			nTasks++;
		}
	...
	class TestHolder : public engine::SlotHolder
	{
	public:
		engine::Signal<int> testSignal;
